...
(create-comp :demo                         init-instant on-tick on-update on-mount render removable?)
(create-comp :demo init-state update-state init-instant on-tick on-update on-mount render removable?)
